...
const BentoTilt = ({ children, className = ''}) => {
   ...
   const handleMouseMove = (e) => {
    ...
    // tilt effect
    const { left, top, width, height} = itemRef.current.getBoundingClientRect(); //get positions of card

    const relativeX = (e.clientX - left) / width; //relative pos of mouse to pos of card
